...
class Headline:
    ...
    def __init__(self, api_key, section):
        ...
        article_content = theguardian_content.Content(
            api=api_key, url=first_api_url, **{"show-blocks": "all"}
        )
    ...
    def get_article_text(self):
        ...
        """
        return self.json_article_content['response']['content']['blocks']\
            ['body'][0]['bodyTextSummary']
